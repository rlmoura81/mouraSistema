...
public class VeiculoDespesa extends ModuloDespesa{
    ...
    public VeiculoDespesa(Veiculo veiculo, int cd_despesa, Calendar dt_despesa, String nm_nota, String ds_descricao, BigDecimal nm_valor, int nm_qtde, Empresa presserv, int cd_usuario) {
